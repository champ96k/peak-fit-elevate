  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — PeakFit" },
      {
        name: "description",
        content:
          "How PeakFit collects, uses, and protects your fitness, health, and personal data.",
      },
      { property: "og:title", content: "Privacy Policy — PeakFit" },
      {
        property: "og:description",
        content: "How PeakFit collects, uses, and protects your data.",
      },
    ],
      ...
      <main className="mx-auto max-w-4xl px-6 py-12 md:py-16">
        ...
        <div className="mt-8 space-y-8 text-[15px] leading-7 text-slate-700">
          <section>
            ...
            <p className="mt-2">
              This Privacy Policy explains how PeakFit Global ("PeakFit", "we", "us", "our")
              collects, uses, stores, shares, and protects personal information when you use PeakFit
              applications, websites, and related services (collectively, the "Service").
            </p>
            <p className="mt-2">
              By using the Service, you acknowledge this Privacy Policy and consent to the
              processing of personal information as described here, where consent is the appropriate
              legal basis.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-6">
              <li>
                ...
                email address, hashed password, account identifiers.
              </li>
              <li>
                <span className="font-semibold text-slate-900">Profile information:</span> age
                range, sex, height, weight, fitness goals, activity level, preferences.
              </li>
              <li>
                <span className="font-semibold text-slate-900">Fitness and wellness data:</span>{" "}
                workouts, sets, reps, intensity, calories, macro intake, hydration, sleep, steps,
                heart-rate trends, weight history, and progress metrics.
              </li>
              <li>
              ...
              <li>
                <span className="font-semibold text-slate-900">Technical and usage data:</span> IP
                address, device type, app version, crash diagnostics, performance logs, and feature
                usage telemetry.
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              (providing the Service), consent (for optional processing), legal obligations, and
              legitimate interests (such as platform security, fraud prevention, and service
              improvement).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Health and fitness-related data may be considered sensitive under applicable laws. We
              process this information only to provide requested product features, with safeguards
              aligned to legal requirements.
            </p>
            <p className="mt-2">
              Health data sourced from Apple HealthKit or Google Health Connect is not used for
              advertising profiling and is handled according to platform policies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              These parties are contractually required to process personal information only for
              authorized purposes and with appropriate security controls.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              implement appropriate transfer safeguards under applicable law.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              based on data type, legal requirements, and account status.
            </p>
            <p className="mt-2">
              When retention is no longer required, data is deleted or anonymized according to our
              internal policies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Subject to local law, you may have rights to access, correct, export, erase, restrict,
              or object to processing of your personal information, and to withdraw consent where
              processing is based on consent.
            </p>
            <p className="mt-2">
              You may also request account deletion through app settings or by contacting us. We may
              need to verify identity before fulfilling privacy requests.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Our web properties may use cookies and similar technologies for login, security,
              preferences, analytics, and performance optimization. Browser controls may allow you
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              including encryption in transit, controlled access, secure infrastructure practices,
              and periodic security reviews.
            </p>
            <p className="mt-2">
              No internet transmission or storage system can be guaranteed 100% secure. Users should
              protect account credentials and report suspected misuse promptly.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              The Service is not intended for children below the minimum age required by applicable
              law without valid guardian authorization. If we become aware that personal information
              was collected in violation of this requirement, we will take appropriate steps, which
          ...
          <section>
            ...
            <p className="mt-2">
              We may revise this Privacy Policy periodically. Updated versions become effective upon
              publication unless otherwise stated. Material changes may be communicated in-app, by
              email, or through website notice.
            </p>
          </section>
